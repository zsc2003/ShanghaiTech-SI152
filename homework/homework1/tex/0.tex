...
\end{problem}
    ...
    $\begin{array}{cl}\underset{x \in \mathbb{R}^n}{\operatorname{minimize}} & f(x) \\ \text { subject to } & c_i(x)=0, \quad i \in \mathcal{E} \\ & c_i(x) \leq 0, \quad i \in \mathcal{I}\end{array}$
